...
class FirebaseManager {
  ...
  FirebaseManager(Context context) {
    ...
    if (app != null) {
      ...
      Log.d(TAG, "Cannot connect to Firebase Database!");
      hotspotListRef = null;
      roomCodeRef = null;
    }
  }
  ...
  void getNewRoomCode(RoomCodeListener listener) {
    Preconditions.checkNotNull(app, "Firebase error!");
    ...
    currentRoomListener =
        new ValueEventListener() {
          ...
          public void onCancelled(DatabaseError databaseError) {
            Log.w(TAG, "Firebase operation cancelled", databaseError.toException());
          }
        };
